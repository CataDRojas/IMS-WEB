...
public class Producto {
    ...
    public void setProductosUsuarioCreacion(String productosUsuarioCreacion) { this.productosUsuarioCreacion = productosUsuarioCreacion; }

    public LocalDateTime getProductosFechaCreacion() { return productosFechaCreacion; }
    public void setProductosFechaCreacion(LocalDateTime productosFechaCreacion) { this.productosFechaCreacion = productosFechaCreacion; }

    public String getProductosUsuarioModif() { return productosUsuarioModif; }
    public void setProductosUsuarioModif(String productosUsuarioModif) { this.productosUsuarioModif = productosUsuarioModif; }

    public LocalDateTime getProductosFechaModif() { return productosFechaModif; }
    public void setProductosFechaModif(LocalDateTime productosFechaModif) { this.productosFechaModif = productosFechaModif; }
}